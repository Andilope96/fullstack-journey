...
let i = 0;
while (i++ < 5) alert( i ); // 0 1 2 3 4 -> alert kommt nach dem postfix increment also am Anfang 1 und am Ende 5
*/
...
for (let i = 0; i < 5; i++) alert( i ); // 1 2 3 4 5 -> Eine Pause wäre gut

The prefix form:

for (let i = 0; i < 5; ++i) alert( i ); // 1 2 3 4 5 -> Langsam hast du Hunger
*/
...
*/
let numberGreater100;
while(numberGreater100<=100){
 numberGreater100 = prompt("Gib mir 110%!",0);
}
